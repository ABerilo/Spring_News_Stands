...
public class Config implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(env.getRequiredProperty("database.connection_url"));
        dataSource.setUsername(env.getRequiredProperty("database.user"));
        dataSource.setPassword(env.getRequiredProperty("database.pass"));
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.vsu.cs.Models");
